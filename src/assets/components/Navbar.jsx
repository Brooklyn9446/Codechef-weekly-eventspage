...
function Navbar(){
    ...
    return(
        <>
        <div className="flex justify-between bg-[#F8F8FA] mt-10">
            ...
            <div className="md:mr-25 sm:mr-7 ">
                <Link to="/" ><button className="bg-[#F8F8FA] text-[16px] border-none font-Aboshi w-[100px] sm:w-[140px] md:w-[161px] h-[53px] cursor-pointer">All Events</button></Link>
